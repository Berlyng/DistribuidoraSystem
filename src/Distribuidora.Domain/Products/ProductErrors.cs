...
namespace Distribuidora.Domain.Products
{
    public static class ProductErrors
    {
        ...
        public static readonly Error NameAlreadyExists = new("Product.NameAlreadyExists", "Ya existe un producto con este nombre");
        ...
        public static readonly Error PresentationRequired = new("Product.PresentationRequired", "El producto debe tener al menos una presentacion");
